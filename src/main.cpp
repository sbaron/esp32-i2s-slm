 ...
 * 
 * Original code from Ivan Kostoski [https://github.com/ikostoski/esp32-i2s-slm]
 *
...
static const double MIC_REF_AMPL = pow(10, double(MIC_SENSITIVITY)/20) * ((1<<(MIC_BITS-1))-1);
...
// I2S CHANNEL - depending on the SEL pin status (high/low)
#define I2S_CHANNEL       I2S_CHANNEL_FMT_ONLY_RIGHT

// Debug only, log FreeRTOS ticks we spent processing the I2S data
//#define I2S_DEBUG
